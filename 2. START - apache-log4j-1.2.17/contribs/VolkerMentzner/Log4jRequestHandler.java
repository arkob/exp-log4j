...
public class Log4jRequestHandler extends RootRequestHandler {
 ...
 /**
  ...
  /**
    ...
    */
  protected static void setDescription(com.psibt.framework.net.RootRequestHandler rootRequestHandler, String description) {
     rootRequestHandler.description = description;
   }

  /**
   * Sets the server path
   *
   * @param rootRequestHandler
   * @param path - the server path
   */
  protected static void setHandledPath(com.psibt.framework.net.RootRequestHandler rootRequestHandler, String path) {
    rootRequestHandler.handledPath = path;
  }

  /**
    * Sets the title for html page
    */
  protected static void setTitle(com.psibt.framework.net.RootRequestHandler rootRequestHandler, String title) {
     rootRequestHandler.title = title;
   }
 ...
 * Gets the description for html page
   * @param rootRequestHandler
   */
public static String getDescription(com.psibt.framework.net.RootRequestHandler rootRequestHandler) {
  return rootRequestHandler.description;
}
 ...
 * @return the server path
   * @param rootRequestHandler
 */
protected static String getHandledPath(com.psibt.framework.net.RootRequestHandler rootRequestHandler) {
  return rootRequestHandler.handledPath;
}
 ...
 * Gets the title for html page
   * @param rootRequestHandler
   */
public static String getTitle(com.psibt.framework.net.RootRequestHandler rootRequestHandler) {
  return rootRequestHandler.title;
}
