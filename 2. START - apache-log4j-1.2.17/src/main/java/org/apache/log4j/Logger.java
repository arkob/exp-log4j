...
public class Logger extends Category {
  ...
  */
  ...
  Logger getLogger(String name, LoggerFactory factory) {
	...
	/** @param myTableModel TODO
	 * @param aRow TODO
	 * @param aCol TODO
	 * @see javax.swing.table.TableModel **/
	public Object getValueAt(MyTableModel myTableModel, int aRow, int aCol) {
	    synchronized (myTableModel.mLock) {
	        final EventDetails event = myTableModel.mFilteredEvents[aRow];
